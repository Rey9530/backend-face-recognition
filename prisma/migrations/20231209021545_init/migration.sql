...
CREATE TABLE "mar_hde_detalle_ho" (
    ...
    "hde_inicio_1" TIME NOT NULL,
    "hde_fin_1" TIME NOT NULL,
    "hde_inicio_2" TIME NOT NULL,
    "hde_fin_2" TIME NOT NULL,
...
-- AddForeignKey
ALTER TABLE "mar_epr_empresas" ADD CONSTRAINT "mar_epr_usr_fk" FOREIGN KEY ("epr_codusr") REFERENCES "mar_usr_usuario"("usr_codigo") ON DELETE NO ACTION ON UPDATE NO ACTION;
